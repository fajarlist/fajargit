...
<div>
<div class="info" >Komedi</div>		
	  <div class="box1" style="margin-left:50px;">
	<?php 
                $result = mysqli_query($koneksi," SELECT * FROM tb_buku WHERE Kategori LIKE '%komedi%'");
                while($data = mysqli_fetch_array($result)){
            ?>	
...
<div>
<div class="info">Romance</div>		
	  <div class="box1" style="margin-left:50px;">
	<?php 
                $result = mysqli_query($koneksi," SELECT * FROM tb_buku WHERE Kategori LIKE '%romance%' LIMIT 3");
                while($data = mysqli_fetch_array($result)){
            ?>	
		<div class="col_1_of_3 span_1_of_3"><a href="single.php?ISBN=<?php echo $data['ISBN'] ?>">
			<div class="view view-fifth">
...
<div>
<div class="info">Horor</div>		
	  <div class="box1" style="margin-left:50px;">
	<?php 
                $result = mysqli_query($koneksi," SELECT * FROM tb_buku WHERE Kategori LIKE '%horor%'");
                while($data = mysqli_fetch_array($result)){
            ?>	
		<div class="col_1_of_3 span_1_of_3"><a href="single.php?ISBN=<?php echo $data['ISBN'] ?>">
			<div class="view view-fifth">
