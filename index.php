            ...
            ?>
				<article style="position: relative; width: 100%; opacity: 1;"> 
				   	<div class="banner-wrap">
						   ...
						   <img src="assets/cover/<?php echo $data['cover'] ?>" style="width:300px">
						</div>
...
<div class="main">
             	  ...
             	  <div class="content-top">
					...
					<div class="cont span_2_of_c1">
					  <div class="social">	
					   ...
					   <div class="social">	
						   <ul>	
                           <div class="btn"><li ><a href="index.php"><span>Random </span></a></li></div>
						  </ul>
			     		</div>
						 <div class="social">	
						   <ul>	
	  ...
	  <div class="box1" >
			<?php 
                $result = mysqli_query($koneksi," SELECT * from tb_buku ORDER BY ISBN DESC LIMIT 12 ");
                while($data = mysqli_fetch_array($result)){
            ?>	
			...
			<div class="view view-fifth">
				<div class="top_box">
					...
					<p class="m_2"><?php echo $data['Tahun']; ?></p>
				        <div class="grid_img">
							<div class="css3"><img src="assets/cover/<?php echo $data['cover'] ?>" width="100px"></div>
								<div class="mask">
